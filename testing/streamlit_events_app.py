"""Streamlit dashboard for evaluating cached hotel deals across multiple events."""
...
def main() -> None:
    ...
    st.caption("Visualise cached hotel deals for upcoming events.")
    ...
    st.markdown(
        f"**{qualified_events} of {total_events} ({percent_display}%)** of events have a deal"
    )
